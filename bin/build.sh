...
ALL_LIST=( ${SRC_DIR}"common.js" ${SRC_DIR}"util/EventEmitter.js" ${SRC_DIR}"util/Stream.js" ${SRC_DIR}"util/Collector.js" ${SRC_DIR}"util/SingleCollector.js" ${SRC_DIR}"search/DocumentTerms.js" ${SRC_DIR}"search/TopDocumentsCollector.js" ${SRC_DIR}"index/DefaultTermIndexer.js" ${SRC_DIR}"util/ArrayStream.js" ${SRC_DIR}"index/MemoryIndex.js" ${SRC_DIR}"search/DefaultSimilarity.js" ${SRC_DIR}"search/Searcher.js" ${SRC_DIR}"search/TermQuery.js" ${SRC_DIR}"search/NormalizedQuery.js" ${SRC_DIR}"search/BooleanClause.js" ${SRC_DIR}"search/BooleanQuery.js" ${SRC_DIR}"search/QueryParser.js" ${SRC_DIR}"search/QueryParserImpl.js" )
