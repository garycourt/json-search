...
ALL_LIST=( ${SRC_DIR}"common.js" ${SRC_DIR}"index/Pipe.js" ${SRC_DIR}"search/DocumentTerms.js" ${SRC_DIR}"util/Collector.js" ${SRC_DIR}"search/TopDocumentsCollector.js" ${SRC_DIR}"search/DefaultSimilarity.js" ${SRC_DIR}"search/Searcher.js" ${SRC_DIR}"search/TermQuery.js" ${SRC_DIR}"index/DefaultTermIndexer.js" ${SRC_DIR}"index/MemoryIndex.js" )
ALL_FILE=${DIST_DIR}"all.js"
EXTERN_LIST=( ${SRC_DIR}"interface/typedefs.js" ${SRC_DIR}"interface/InputStream.js" ${SRC_DIR}"interface/OutputStream.js" ${SRC_DIR}"interface/Query.js" ${SRC_DIR}"interface/Index.js" ${SRC_DIR}"interface/Scorer.js" ${SRC_DIR}"interface/TermVectorEntry.js" ${SRC_DIR}"interface/TermVector.js" ${SRC_DIR}"interface/Similarity.js" ${SRC_DIR}"interface/TermIndexer.js" )
