...
0,b.end()):b.write()}}(i),g.on("end",e),g.on("close",e)};
...
k;k=d!==null?d:"";k=k!==null?function(a){a&&(a=a[1]);return typeof a==="number"?a:1}(k):null;(l=h)&&k===null&&i("boost");m[c]={nextPos:f,result:k};return k}function y(){var c="TermQuery@"+f,h=m[c];if(h)return f=h.nextPos,h.result;var d=h=f,e=v();if(e!==null){if(a.substr(f,1)===":"){var g=":";f+=1}else g=null,l&&i('":"');g!==null?e=[e,g]:(e=null,f=d)}else e=null,f=d;d=e!==null?e:"";d!==null?(e=v(),e!==null?(g=w(),g!==null?d=[d,e,g]:(d=null,f=h)):(d=null,f=h)):(d=null,f=h);h=d!==null?new TermQuery(d[1],
d[0]?d[0][0]:D,d[2]):null;m[c]={nextPos:f,result:h};return h}function r(){var c="BooleanClause@"+f,d=m[c];if(d)return f=d.nextPos,d.result;d=f;if(a.substr(f,1)==="+"){var e="+";f+=1}else e=null,l&&i('"+"');e===null&&(a.substr(f,1)==="-"?(e="-",f+=1):(e=null,l&&i('"-"')),e=e!==null?e:null);e=e!==null?e:"";if(e!==null){var g=z();g===null&&(g=y(),g=g!==null?g:null);g!==null?e=[e,g]:(e=null,f=d)}else e=null,f=d;d=e!==null?function(a,b){a=a==="+"?Occur.MUST:a==="-"?Occur.MUST_NOT:Occur.SHOULD;return new BooleanClause(b,
