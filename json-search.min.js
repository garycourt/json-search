...
function StandardAnalyzer(){this.analyzer=new PorterFilter(new StopFilter(new LowerCaseFilter(new StandardTokenizer),StandardAnalyzer.ENGLISH_STOP_WORDS))}StandardAnalyzer.ENGLISH_STOP_WORDS=StopFilter.toHash(["a","an","and","are","as","at","be","but","by","for","if","in","into","is","it","no","not","of","on","or","such","that","the","their","then","there","these","they","this","to","was","will","with"]);StandardAnalyzer.prototype.tokenize=function(a){return this.analyzer.tokenize(a)};
exports.StandardAnalyzer=StandardAnalyzer;function StandardTokenizer(){}StandardTokenizer.LETTER=/[A-Za-z]/;StandardTokenizer.SKIP_LETTER=/['&@.\-_]/;StandardTokenizer.DIGIT=/[0-9]/;StandardTokenizer.ALPHANUM=/[0-9A-Za-z]/;
...
{type:i,value:h,startOffset:g,endOffset:d,positionIncrement:1},e=StandardTokenizerState.UNKNOWN,i=!1,--d}return p};StandardTokenizerState={UNKNOWN:0,STRING:1,INT:2,FLOAT:3};function DefaultIndexer(){}
DefaultIndexer.prototype.index=function(a,d,c){var b,e,g=[];switch(typeOf(a)){case "null":case "boolean":case "number":g[0]={term:a,field:c||null,documentID:d};break;case "string":a=a.replace(/[^\w\d]/g," ").replace(/\s\s/g," ").toLowerCase().split(" ");b={};for(e=0;e<a.length;++e)b[a[e]]?(b[a[e]].termFrequency++,b[a[e]].termPositions.push(e)):b[a[e]]={term:a[e],termFrequency:1,termPositions:[e],field:c,totalFieldTokens:a.length,documentID:d};for(e in b)b[e]!==O[e]&&(g[g.length]=b[e]);break;case "object":for(e in a)a[e]!==
O[e]&&(g=g.concat(this.index(a[e],d,c?c+"."+e:e)));break;case "array":for(e=0;e<a.length;++e)g=g.concat(this.index(a[e],d,c?c+"."+e:String(e)))}return g};DefaultIndexer.prototype.toSource=function(){};exports.DefaultIndexer=DefaultIndexer;function MemoryIndex(){this._docs={};this._index={};this._indexKeys=new ScapegoatTree}MemoryIndex.documentIDComparator=function(a,d){if(a.documentID<d.documentID)return-1;else if(a.documentID>d.documentID)return 1;return 0};
MemoryIndex.stringComparator=function(a,d){if(a<d)return-1;else if(a>d)return 1;return 0};MemoryIndex.prototype._docCount=0;MemoryIndex.prototype._indexer=new DefaultIndexer;MemoryIndex.prototype.generateID=function(){return String(Math.random())};
...
PhraseFilter.prototype.onWrite=function(a){var d,c,b,e,g,h,i=this._query.terms,p=this._query.slop;b=a.terms;var v={},w,y,z,r;d=0;for(c=b.length;d<c;++d)if(!(v[b[d].term]=b[d].termPositions))return;w=v[i[0]];d=0;for(c=w.length;d<c;++d){b=1;for(e=i.length;b<e;++b)if(typeof i[b]!=="undefined"){y=w[d]+b-p;z=w[d]+b+p;r=v[i[b]];g=0;for(h=r.length;g<h;++g)if(r[g]>=y&&r[g]<=z)break;if(g>=h)break}if(b>=e){this.emit(a);break}}};exports.PhraseQuery=PhraseQuery;
...
QueryParser.impl=function(){var a={parse:function(a,c,b){function e(a){var d=a.charCodeAt(0);if(d<=255)var a="x",c=2;else a="u",c=4;var a="\\"+a,b=d.toString(16).toUpperCase(),d=b;c-=b.length;for(b=0;b<c;b++)d="0"+d;return a+d}function g(a){return'"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/[\x80-\uFFFF]/g,e)+'"'}function h(a){f<A||(f>A&&(A=f,C=[]),C.push(a))}function i(){var c="WHITESPACE@"+f,b=k[c];if(b)return f=b.nextPos,b.result;b=j;j=!1;if(a.substr(f).match(/^[ \t\n\r\u3000]/)!==
null){var t=a.charAt(f);f++}else t=null,j&&h("[ \t\\n\\r\\u3000]");(j=b)&&t===null&&h("whitespace");k[c]={nextPos:f,result:t};return t}function p(){var a="SKIP@"+f,d=k[a];if(d)return f=d.nextPos,d.result;for(var d=[],c=i();c!==null;)d.push(c),c=i();k[a]={nextPos:f,result:d};return d}function v(){var c="Number@"+f,b=k[c];if(b)return f=b.nextPos,b.result;b=j;j=!1;var t=f;if(a.substr(f).match(/^[0-9]/)!==null){var e=a.charAt(f);f++}else e=null,j&&h("[0-9]");if(e!==null)for(var g=[];e!==null;)g.push(e),
a.substr(f).match(/^[0-9]/)!==null?(e=a.charAt(f),f++):(e=null,j&&h("[0-9]"));else g=null;if(g!==null){e=f;if(a.substr(f,1)==="."){var o=".";f+=1}else o=null,j&&h('"."');if(o!==null){if(a.substr(f).match(/^[0-9]/)!==null){var m=a.charAt(f);f++}else m=null,j&&h("[0-9]");if(m!==null)for(var l=[];m!==null;)l.push(m),a.substr(f).match(/^[0-9]/)!==null?(m=a.charAt(f),f++):(m=null,j&&h("[0-9]"));else l=null;l!==null?o=[o,l]:(o=null,f=e)}else o=null,f=e;e=o!==null?o:"";e!==null?g=[g,e]:(g=null,f=t)}else g=
null,f=t;t=g!==null?parseFloat(g[0].concat(g[1][0],g[1][1]).join("")):null;(j=b)&&t===null&&h("number");k[c]={nextPos:f,result:t};return t}function w(){var c="ESCAPED_CHAR@"+f,b=k[c];if(b)return f=b.nextPos,b.result;b=f;if(a.substr(f,1)==="\\"){var e="\\";f+=1}else e=null,j&&h('"\\\\"');if(e!==null){if(a.length>f){var g=a.charAt(f);f++}else g=null,j&&h("any character");g!==null?e=[e,g]:(e=null,f=b)}else e=null,f=b;k[c]={nextPos:f,result:e};return e}function y(){var c="TERM_START_CHAR@"+f,b=k[c];if(b)return f=
b.nextPos,b.result;a.substr(f).match(/^[^ \t\n\r\u3000+\-!():^[\]"{}~*?\\]/)!==null?(b=a.charAt(f),f++):(b=null,j&&h('[^ \t\\n\\r\\u3000+\\-!():^[\\]"{}~*?\\\\]'));k[c]={nextPos:f,result:b};return b}function z(){var c="TERM_CHAR@"+f,b=k[c];if(b)return f=b.nextPos,b.result;b=y();b===null&&(b=w(),b===null&&(a.substr(f,1)==="-"?(b="-",f+=1):(b=null,j&&h('"-"')),b===null&&(a.substr(f,1)==="+"?(b="+",f+=1):(b=null,j&&h('"+"')),b=b!==null?b:null)));k[c]={nextPos:f,result:b};return b}function r(){var a=
"Term@"+f,d=k[a];if(d)return f=d.nextPos,d.result;d=j;j=!1;var c=f,b=y();if(b!==null){for(var e=[],g=z();g!==null;)e.push(g),g=z();e!==null?b=[b,e]:(b=null,f=c)}else b=null,f=c;c=b!==null?[b[0]].concat(b[1]).join(""):null;(j=d)&&c===null&&h("term");k[a]={nextPos:f,result:c};return c}function D(){var c="Boost@"+f,b=k[c];if(b)return f=b.nextPos,b.result;b=j;j=!1;var e=f;if(a.substr(f,1)==="^"){var g="^";f+=1}else g=null,j&&h('"^"');if(g!==null){var q=v();q!==null?g=[g,q]:(g=null,f=e)}else g=null,f=
e;e=g!==null?g:"";e=e!==null?function(a){a&&(a=a[1]);return typeof a==="number"?a:1}(e):null;(j=b)&&e===null&&h("boost");k[c]={nextPos:f,result:e};return e}function E(){var c="TermType@"+f,b=k[c];if(b)return f=b.nextPos,b.result;var b=f,e=r();if(e!==null){if(a.substr(f,1)==="*"){var g="*";f+=1}else g=null,j&&h('"*"');g=g!==null?g:"";g!==null?e=[e,g]:(e=null,f=b)}else e=null,f=b;b=e!==null?e[1]?{prefix:e[0]}:{term:e[0]}:null;k[c]={nextPos:f,result:b};return b}function G(){var c="Range@"+f,b=k[c];if(b)return f=
b.nextPos,b.result;b=f;if(a.substr(f,1)==="["){var e="[";f+=1}else e=null,j&&h('"["');e===null&&(a.substr(f,1)==="{"?(e="{",f+=1):(e=null,j&&h('"{"')),e=e!==null?e:null);if(e!==null){var g=p();if(g!==null){var q=r();if(q!==null){var o=p();if(o!==null){if(a.substr(f,2)==="TO"){var m="TO";f+=2}else m=null,j&&h('"TO"');m===null&&(a.substr(f,1)==="-"?(m="-",f+=1):(m=null,j&&h('"-"')),m=m!==null?m:null);m=m!==null?m:"";if(m!==null){var l=p();if(l!==null){var i=r();if(i!==null){var u=p();if(u!==null){if(a.substr(f,
1)==="]"){var s="]";f+=1}else s=null,j&&h('"]"');s===null&&(a.substr(f,1)==="}"?(s="}",f+=1):(s=null,j&&h('"}"')),s=s!==null?s:null);s!==null?e=[e,g,q,o,m,l,i,u,s]:(e=null,f=b)}else e=null,f=b}else e=null,f=b}else e=null,f=b}else e=null,f=b}else e=null,f=b}else e=null,f=b}else e=null,f=b}else e=null,f=b;b=e!==null?{startTerm:e[2],endTerm:e[6],excludeStart:e[0]==="{",excludeEnd:e[8]==="}"}:null;k[c]={nextPos:f,result:b};return b}function H(){var b="Phrase@"+f,c=k[b];if(c)return f=c.nextPos,c.result;
c=f;if(a.substr(f,1)==='"'){var e='"';f+=1}else e=null,j&&h('"\\""');if(e!==null){var g=p();if(g!==null){var q=r();if(q!==null){var o=[],m=f,l=i();if(l!==null)for(var n=[];l!==null;)n.push(l),l=i();else n=null;n!==null?(l=r(),l!==null?n=[n,l]:(n=null,f=m)):(n=null,f=m);for(;n!==null;){o.push(n);m=f;l=i();if(l!==null)for(n=[];l!==null;)n.push(l),l=i();else n=null;n!==null?(l=r(),l!==null?n=[n,l]:(n=null,f=m)):(n=null,f=m)}if(o!==null)if(m=p(),m!==null)if(a.substr(f,1)==='"'?(n='"',f+=1):(n=null,j&&
h('"\\""')),n!==null){l=f;if(a.substr(f,1)==="~"){var u="~";f+=1}else u=null,j&&h('"~"');if(u!==null){var s=v();s!==null?u=[u,s]:(u=null,f=l)}else u=null,f=l;l=u!==null?u:"";l!==null?e=[e,g,q,o,m,n,l]:(e=null,f=c)}else e=null,f=c;else e=null,f=c;else e=null,f=c}else e=null,f=c}else e=null,f=c}else e=null,f=c;c=e!==null?function(a,c,b){a=[a];if(c)for(var d=0,e=c.length;d<e;++d)a.push(c[d][1]);return{phrase:a,slop:b?b[1]:0}}(e[2],e[3],e[6]):null;k[b]={nextPos:f,result:c};return c}function I(){var c=
"TermQuery@"+f,b=k[c];if(b)return f=b.nextPos,b.result;var e=b=f,g=r();if(g!==null){if(a.substr(f,1)===":"){var q=":";f+=1}else q=null,j&&h('":"');q!==null?g=[g,q]:(g=null,f=e)}else g=null,f=e;e=g!==null?g:"";e!==null?(g=H(),g===null&&(g=G(),g===null&&(g=E(),g=g!==null?g:null)),g!==null?(q=D(),q!==null?e=[e,g,q]:(e=null,f=b)):(e=null,f=b)):(e=null,f=b);b=e!==null?function(a,b,c){a=a?a[0]:N;return b.phrase?new PhraseQuery(a,b.phrase,b.slop,c):b.startTerm?new TermRangeQuery(a,b.startTerm,b.endTerm,
b.excludeStart,b.excludeEnd,c):b.prefix?new PrefixQuery(a,b.prefix,c):new TermQuery(a,b.term,c)}(e[0],e[1],e[2]):null;k[c]={nextPos:f,result:b};return b}function B(){var b="BooleanClause@"+f,c=k[b];if(c)return f=c.nextPos,c.result;c=f;if(a.substr(f,1)==="+"){var e="+";f+=1}else e=null,j&&h('"+"');e===null&&(a.substr(f,1)==="-"?(e="-",f+=1):(e=null,j&&h('"-"')),e=e!==null?e:null);e=e!==null?e:"";if(e!==null){var g=J();g===null&&(g=I(),g=g!==null?g:null);g!==null?e=[e,g]:(e=null,f=c)}else e=null,f=
c;c=e!==null?function(a,b){a=a==="+"?Occur.MUST:a==="-"?Occur.MUST_NOT:Occur.SHOULD;return new BooleanClause(b,a)}(e[0],e[1]):null;k[b]={nextPos:f,result:c};return c}function K(){var a="BooleanQuery@"+f,b=k[a];if(b)return f=b.nextPos,b.result;var b=f,c=B();if(c!==null){var d=[],e=f,g=i();if(g!==null)for(var h=[];g!==null;)h.push(g),g=i();else h=null;h!==null?(g=B(),g!==null?h=[h,g]:(h=null,f=e)):(h=null,f=e);for(;h!==null;){d.push(h);e=f;g=i();if(g!==null)for(h=[];g!==null;)h.push(g),g=i();else h=
null;h!==null?(g=B(),g!==null?h=[h,g]:(h=null,f=e)):(h=null,f=e)}d!==null?c=[c,d]:(c=null,f=b)}else c=null,f=b;b=c!==null?function(a,b){var c=[a];if(b)for(var d=0,e=b.length;d<e;++d)c[c.length]=b[d][1];return new BooleanQuery(c)}(c[0],c[1]):null;k[a]={nextPos:f,result:b};return b}function J(){var b="SubQuery@"+f,c=k[b];if(c)return f=c.nextPos,c.result;c=f;if(a.substr(f,1)==="("){var e="(";f+=1}else e=null,j&&h('"("');if(e!==null){var g=L();if(g!==null){if(a.substr(f,1)===")"){var i=")";f+=1}else i=
null,j&&h('")"');if(i!==null){var o=D();o!==null?e=[e,g,i,o]:(e=null,f=c)}else e=null,f=c}else e=null,f=c}else e=null,f=c;c=e!==null?function(a,c){a.boost=c;return a}(e[1],e[3]):null;k[b]={nextPos:f,result:c};return c}function L(){var a="Query@"+f,c=k[a];if(c)return f=c.nextPos,c.result;var c=f,b=p();if(b!==null){var d=K();if(d!==null){var e=p();e!==null?b=[b,d,e]:(b=null,f=c)}else b=null,f=c}else b=null,f=c;c=b!==null?b[1]:null;k[a]={nextPos:f,result:c};return c}function P(){var c=function(a){a.sort();
for(var c=null,b=[],d=0;d<a.length;d++)a[d]!==c&&(b.push(a[d]),c=a[d]);switch(b.length){case 0:return"end of input";case 1:return b[0];default:return b.slice(0,b.length-1).join(", ")+" or "+b[b.length-1]}}(C),b=Math.max(f,A),b=b<a.length?g(a.charAt(b)):"end of input";return"Expected "+c+" but "+b+" found."}function Q(){for(var b=1,c=1,e=!1,f=0;f<A;f++){var g=a.charAt(f);g==="\n"?(e||b++,c=1,e=!1):g==="\r"|g==="\u2028"||g==="\u2029"?(b++,c=1,e=!0):(c++,e=!1)}return{line:b,column:c}}var M={BooleanClause:B,
BooleanQuery:K,Boost:D,ESCAPED_CHAR:w,Number:v,Phrase:H,Query:L,Range:G,SKIP:p,SubQuery:J,TERM_CHAR:z,TERM_START_CHAR:y,Term:r,TermQuery:I,TermType:E,WHITESPACE:i};if(c!==void 0){if(M[c]===void 0)throw Error("Invalid rule name: "+g(c)+".");}else c="Query";var f=0,j=!0,A=0,C=[],k={},N=b||null,c=M[c]();if(c===null||f!==a.length)throw c=Q(),new this.SyntaxError(P(),c.line,c.column);return c},toSource:function(){return typeof this._source==="string"?this._source:this.toString()},SyntaxError:function(a,
